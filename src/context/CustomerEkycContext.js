...
import { AxiosPost, AxiosGet, AxiosPostURL } from './Axios'
...
export const CustomerEkycContextProvider = (props) => {
  ...
  //     });
  // };
  async function getPartner(data, handleApiRes, handleApiError) {
    console.log(data);
    await AxiosPost("getPartnerList", data,
      (apiRes) => {
        handleApiRes(apiRes)
      }, (apiError) => {
  ...
  async function getReseller(data, handleApiRes, handleApiError) {
    console.log("inside get Reseller", data);
  ...
  async function getCustomerDataByMobile(mobile, handleApiRes, handleApiError) {
    let body = {
      "Request": {
        "requestDate": "2002-05-30T09:00:00",
        "extTransactionId": "-99999",
    ...
    await AxiosPostURL("https://payments.tripleplay.in/users/searchUser", body,
      (apiRes) => {
        handleApiRes(apiRes)
      }, (apiError) => {
        handleApiError(apiError)
  ...
  return <CustomerEkycContext.Provider value={{
    ...
    setPartnerListOptions: setPartnerListOptions,
    setResellerListOptions: setResellerListOptions,
    setPlanListOptions: setPlanListOptions,
    getPartner: getPartner,
    getReseller: getReseller,
    getPlan: getPlan,
    getCustomerDataByMobile: getCustomerDataByMobile
